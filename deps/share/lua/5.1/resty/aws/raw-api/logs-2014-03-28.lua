...
return assert(decode([===[
{
  ...
  "operations": {
    ...
    "CreateExportTask": {
      ...
      "input": {
        "shape": "CreateExportTaskRequest"
      },
      "output": {
        "shape": "CreateExportTaskResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DeleteQueryDefinition": {
      ...
      "input": {
        "shape": "DeleteQueryDefinitionRequest"
      },
      "output": {
        "shape": "DeleteQueryDefinitionResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DeleteSubscriptionFilter": {
      ...
      "input": {
        "shape": "DeleteSubscriptionFilterRequest"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DescribeDestinations": {
      ...
      "input": {
        "shape": "DescribeDestinationsRequest"
      },
      "output": {
        "shape": "DescribeDestinationsResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DescribeQueries": {
      ...
      "input": {
        "shape": "DescribeQueriesRequest"
      },
      "output": {
        "shape": "DescribeQueriesResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DescribeQueryDefinitions": {
      ...
      "input": {
        "shape": "DescribeQueryDefinitionsRequest"
      },
      "output": {
        "shape": "DescribeQueryDefinitionsResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DescribeResourcePolicies": {
      ...
      "input": {
        "shape": "DescribeResourcePoliciesRequest"
      },
      "output": {
        "shape": "DescribeResourcePoliciesResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "DescribeSubscriptionFilters": {
      ...
      "input": {
        "shape": "DescribeSubscriptionFiltersRequest"
      },
      "output": {
        "shape": "DescribeSubscriptionFiltersResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "FilterLogEvents": {
      ...
      "input": {
        "shape": "FilterLogEventsRequest"
      },
      "output": {
        "shape": "FilterLogEventsResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "GetLogGroupFields": {
      ...
      "input": {
        "shape": "GetLogGroupFieldsRequest"
      },
      "output": {
        "shape": "GetLogGroupFieldsResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "GetLogRecord": {
      ...
      "input": {
        "shape": "GetLogRecordRequest"
      },
      "output": {
        "shape": "GetLogRecordResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "ListTagsLogGroup": {
      ...
      "input": {
        "shape": "ListTagsLogGroupRequest"
      },
      "output": {
        "shape": "ListTagsLogGroupResponse"
      },
      "errors": [
        {
          "shape": "ResourceNotFoundException"
    ...
    "PutDestination": {
      ...
      "input": {
        "shape": "PutDestinationRequest"
      },
      "output": {
        "shape": "PutDestinationResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "PutDestinationPolicy": {
      ...
      "input": {
        "shape": "PutDestinationPolicyRequest"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "PutQueryDefinition": {
      ...
      "input": {
        "shape": "PutQueryDefinitionRequest"
      },
      "output": {
        "shape": "PutQueryDefinitionResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "PutSubscriptionFilter": {
      ...
      "input": {
        "shape": "PutSubscriptionFilterRequest"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
    ...
    "StartQuery": {
      ...
      "input": {
        "shape": "StartQueryRequest"
      },
      "output": {
        "shape": "StartQueryResponse"
      },
      "errors": [
        {
    ...
    "StopQuery": {
      ...
      "input": {
        "shape": "StopQueryRequest"
      },
      "output": {
        "shape": "StopQueryResponse"
      },
      "errors": [
        {
          "shape": "InvalidParameterException"
  ...
  "shapes": {
    ...
    "DescribeMetricFiltersRequest": {
      ...
      "members": {
        ...
        "filterNamePrefix": {
          "shape": "FilterName",
          "documentation": "<p>The prefix to match. CloudWatch Logs uses the value you set here only if you also include the <code>logGroupName</code> parameter in your request.</p>"
        },
        "nextToken": {
          "shape": "NextToken",
          "documentation": "<p>The token for the next set of items to return. (You received this token from a previous call.)</p>"
    ...
    "FilterLogEventsRequest": {
      ...
      "members": {
        ...
        "startTime": {
          "shape": "Timestamp",
          "documentation": "<p>The start of the time range, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC. Events with a timestamp before this time are not returned.</p> <p>If you omit <code>startTime</code> and <code>endTime</code> the most recent log events are retrieved, to up 1 MB or 10,000 log events.</p>"
        },
        "endTime": {
          "shape": "Timestamp",
    ...
    "FilterLogEventsResponse": {
      ...
      "members": {
        ...
        "searchedLogStreams": {
          ...
          "documentation": "<p> <b>IMPORTANT</b> Starting on May 15, 2020, this parameter will be deprecated. This parameter will be an empty list after the deprecation occurs.</p> <p>Indicates which log streams have been searched and whether each has been searched completely.</p>"
        },
        "nextToken": {
          "shape": "NextToken",
    ...
    "GetLogEventsRequest": {
      ...
      "members": {
        ...
        "nextToken": {
          "shape": "NextToken",
          "documentation": "<p>The token for the next set of items to return. (You received this token from a previous call.)</p> <p>Using this token works only when you specify <code>true</code> for <code>startFromHead</code>.</p>"
        },
        "limit": {
          "shape": "EventsLimit",
    ...
    "GetLogEventsResponse": {
      ...
      "members": {
        ...
        "nextBackwardToken": {
          "shape": "NextToken",
          "documentation": "<p>The token for the next set of items in the backward direction. The token expires after 24 hours. This token is never null. If you have reached the end of the stream, it returns the same token you passed in.</p>"
        }
      }
    },
    ...
    "LogStream": {
      ...
      "members": {
        ...
        "storedBytes": {
          "shape": "StoredBytes",
          "documentation": "<p>The number of bytes stored.</p> <p> <b>Important:</b> On June 17, 2019, this parameter was deprecated for log streams, and is always reported as zero. This change applies only to log streams. The <code>storedBytes</code> parameter for log groups is not affected.</p>",
          "deprecated": true,
