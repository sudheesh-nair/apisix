...
return assert(decode([===[
{
  ...
  "operations": {
    ...
    "PostContent": {
      ...
      "input": {
        "shape": "PostContentRequest"
      },
      "output": {
        "shape": "PostContentResponse"
      },
      "errors": [
        {
          "shape": "NotFoundException"
    ...
    "PostText": {
      ...
      "input": {
        "shape": "PostTextRequest"
      },
      "output": {
        "shape": "PostTextResponse"
      },
      "errors": [
        {
          "shape": "NotFoundException"
    ...
    "PutSession": {
      ...
      "input": {
        "shape": "PutSessionRequest"
      },
      "output": {
        "shape": "PutSessionResponse"
      },
      "errors": [
        {
          "shape": "NotFoundException"
