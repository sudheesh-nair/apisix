  ...
  "shapes": {
    ...
    "ApplicationSettingsResource": {
      ...
      "members": {
        ...
        "Limits": {
          ...
          "documentation": "<p>The default sending limits for campaigns and journeys in the application.</p>"
        },
        "QuietTime": {
          "shape": "QuietTime",
    ...
    "CampaignLimits": {
      ...
      "members": {
        ...
        "MessagesPerSecond": {
          "shape": "__integer",
          "documentation": "<p>The maximum number of messages that a campaign can send each second. For an application, this value specifies the default limit for the number of messages that campaigns and journeys can send each second. The minimum value is 50. The maximum value is 20,000.</p>"
        },
        "Total": {
          "shape": "__integer",
      ...
      "documentation": "<p>For a campaign, specifies limits on the messages that the campaign can send. For an application, specifies the default limits for messages that campaigns and journeys in the application can send.</p>"
    },
    "CampaignResponse": {
      "type": "structure",
      "members": {
        ...
        "TemplateConfiguration": {
          ...
          "documentation": "<p>The message template that’s used for the campaign.</p>"
        },
    ...
    "CreateRecommenderConfiguration": {
      ...
      "members": {
        ...
        "Description": {
          "shape": "__string",
          "documentation": "<p>A custom description of the configuration for the recommender model. The description can contain up to 128 characters. The characters can be letters, numbers, spaces, or the following symbols: _ ; () , ‐.</p>"
        },
        "Name": {
          "shape": "__string",
    ...
    "EndpointBatchItem": {
      ...
      "members": {
        ...
        "EndpointStatus": {
          "shape": "__string",
          "documentation": "<p>Specifies whether to send messages or push notifications to the endpoint. Valid values are: ACTIVE, messages are sent to the endpoint; and, INACTIVE, messages aren’t sent to the endpoint.</p> <p>Amazon Pinpoint automatically sets this value to ACTIVE when you create an endpoint or update an existing endpoint. Amazon Pinpoint automatically sets this value to INACTIVE if you update another endpoint that has the same address specified by the Address property.</p>"
        },
        "Id": {
          "shape": "__string",
    ...
    "EndpointResponse": {
      ...
      "members": {
        ...
        "EndpointStatus": {
          "shape": "__string",
          "documentation": "<p>Specifies whether messages or push notifications are sent to the endpoint. Possible values are: ACTIVE, messages are sent to the endpoint; and, INACTIVE, messages aren’t sent to the endpoint.</p> <p>Amazon Pinpoint automatically sets this value to ACTIVE when you create an endpoint or update an existing endpoint. Amazon Pinpoint automatically sets this value to INACTIVE if you update another endpoint that has the same address specified by the Address property.</p>"
        },
        "Id": {
          "shape": "__string",
    ...
    "MessageRequest": {
      ...
      "members": {
        ...
        "Endpoints": {
          ...
          "documentation": "<p>A map of key-value pairs, where each key is an endpoint ID and each value is an EndpointSendConfiguration object. You can use an EndpointSendConfiguration object to tailor the message for an endpoint by specifying settings such as content overrides and message variables.</p>"
        },
        "MessageConfiguration": {
    ...
    "ResultRow": {
      ...
      "members": {
        "GroupedBys": {
          ...
          "documentation": "<p>An array of objects that defines the field and field values that were used to group data in a result set that contains multiple results. This value is null if the data in a result set isn’t grouped.</p>"
        },
        "Values": {
          "shape": "ListOfResultRowValue",
    ...
    "SendUsersMessageRequest": {
      ...
      "members": {
        ...
        "Users": {
          "shape": "MapOfEndpointSendConfiguration",
          "documentation": "<p>A map that associates user IDs with EndpointSendConfiguration objects. You can use an EndpointSendConfiguration object to tailor the message for a user by specifying settings such as content overrides and message variables.</p>"
        }
      },
    ...
    "WriteApplicationSettingsRequest": {
      ...
      "members": {
        ...
        "Limits": {
          "shape": "CampaignLimits",
          "documentation": "<p>The default sending limits for campaigns and journeys in the application. To override these limits and define custom limits for a specific campaign or journey, use the <link  linkend=\"apps-application-id-campaigns-campaign-id\">Campaign</link> resource or the <link  linkend=\"apps-application-id-journeys-journey-id\">Journey</link> resource, respectively.</p>"
        },
        "QuietTime": {
          "shape": "QuietTime",
