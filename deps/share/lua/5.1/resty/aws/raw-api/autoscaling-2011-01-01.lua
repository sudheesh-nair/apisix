...
return assert(decode([===[
{
  ...
  "operations": {
    ...
    "AttachLoadBalancerTargetGroups": {
      ...
      "input": {
        "shape": "AttachLoadBalancerTargetGroupsType"
      },
      "output": {
    ...
    "BatchDeleteScheduledAction": {
      ...
      "input": {
        "shape": "BatchDeleteScheduledActionType"
      },
      "output": {
    ...
    "BatchPutScheduledUpdateGroupAction": {
      ...
      "input": {
        "shape": "BatchPutScheduledUpdateGroupActionType"
      },
      "output": {
    ...
    "CancelInstanceRefresh": {
      ...
      "input": {
        "shape": "CancelInstanceRefreshType"
      },
      "output": {
    ...
    "DescribeInstanceRefreshes": {
      ...
      "input": {
        "shape": "DescribeInstanceRefreshesType"
      },
      "output": {
    ...
    "DescribeLoadBalancerTargetGroups": {
      ...
      "input": {
        "shape": "DescribeLoadBalancerTargetGroupsRequest"
      },
      "output": {
    ...
    "DetachLoadBalancerTargetGroups": {
      ...
      "input": {
        "shape": "DetachLoadBalancerTargetGroupsType"
      },
      "output": {
    ...
    "SetInstanceProtection": {
      ...
      "input": {
        "shape": "SetInstanceProtectionQuery"
      },
      "output": {
  ...
  "shapes": {
    ...
    "CreateAutoScalingGroupType": {
      ...
      "members": {
        ...
        "DesiredCapacity": {
          "shape": "AutoScalingGroupDesiredCapacity",
          "documentation": "<p>The desired capacity is the initial capacity of the Auto Scaling group at the time of its creation and the capacity it attempts to maintain. It can scale beyond this capacity if you configure automatic scaling.</p> <p>This number must be greater than or equal to the minimum size of the group and less than or equal to the maximum size of the group. If you do not specify a desired capacity, the default is the minimum size of the group.</p>"
        },
        "DefaultCooldown": {
          "shape": "Cooldown",
    ...
    "CreateLaunchConfigurationType": {
      ...
      "members": {
        ...
        "MetadataOptions": {
          ...
          "documentation": "<p>The metadata options for the instances. For more information, see <a href=\"https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html\">Instance Metadata and User Data</a> in the <i>Amazon EC2 User Guide for Linux Instances</i>.</p>"
        }
      }
    },
    ...
    "FailedScheduledUpdateGroupActionRequests": {
      "type": "list",
      "member": {
        "shape": "FailedScheduledUpdateGroupActionRequest"
      }
    },
    "Filter": {
      "type": "structure",
    ...
    "LifecycleHookSpecifications": {
      "type": "list",
      "member": {
        "shape": "LifecycleHookSpecification"
      }
    },
    "LifecycleHooks": {
      "type": "list",
    ...
    "LoadBalancerTargetGroupStates": {
      "type": "list",
      "member": {
        "shape": "LoadBalancerTargetGroupState"
      }
    },
    "MaxInstanceLifetime": {
      "type": "integer"
    ...
    "ScheduledUpdateGroupActionRequests": {
      "type": "list",
      "member": {
        "shape": "ScheduledUpdateGroupActionRequest"
      }
    },
    "ScheduledUpdateGroupActions": {
      "type": "list",
    ...
    "SuspendedProcess": {
      ...
      "documentation": "<p>Describes an automatic scaling process that has been suspended.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-suspend-resume-processes.html#process-types\">Scaling Processes</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>"
    },
    "SuspendedProcesses": {
      "type": "list",
      "member": {
    ...
    "UpdateAutoScalingGroupType": {
      ...
      "members": {
        ...
        "DesiredCapacity": {
          "shape": "AutoScalingGroupDesiredCapacity",
          "documentation": "<p>The desired capacity is the initial capacity of the Auto Scaling group after this operation completes and the capacity it attempts to maintain.</p> <p>This number must be greater than or equal to the minimum size of the group and less than or equal to the maximum size of the group.</p>"
        },
        "DefaultCooldown": {
          "shape": "Cooldown",
          "documentation": "<p>The amount of time, in seconds, after a scaling activity completes before another scaling activity can start. The default value is <code>300</code>.</p> <p>This setting applies when using simple scaling policies, but not when using other scaling policies or scheduled scaling. For more information, see <a href=\"https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html\">Scaling Cooldowns for Amazon EC2 Auto Scaling</a> in the <i>Amazon EC2 Auto Scaling User Guide</i>.</p>"
