...
return assert(decode([===[
{
  ...
  "operations": {
    ...
    "CreateByteMatchSet": {
      ...
      "input": {
        "shape": "CreateByteMatchSetRequest"
      },
      "output": {
        "shape": "CreateByteMatchSetResponse"
      },
      "errors": [
        {
    ...
    "CreateGeoMatchSet": {
      ...
      "input": {
        "shape": "CreateGeoMatchSetRequest"
      },
      "output": {
        "shape": "CreateGeoMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "CreateRateBasedRule": {
      ...
      "input": {
        "shape": "CreateRateBasedRuleRequest"
      },
      "output": {
        "shape": "CreateRateBasedRuleResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "CreateRegexMatchSet": {
      ...
      "input": {
        "shape": "CreateRegexMatchSetRequest"
      },
      "output": {
        "shape": "CreateRegexMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "CreateSizeConstraintSet": {
      ...
      "input": {
        "shape": "CreateSizeConstraintSetRequest"
      },
      "output": {
        "shape": "CreateSizeConstraintSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "CreateSqlInjectionMatchSet": {
      ...
      "input": {
        "shape": "CreateSqlInjectionMatchSetRequest"
      },
      "output": {
        "shape": "CreateSqlInjectionMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFDisallowedNameException"
    ...
    "CreateWebACLMigrationStack": {
      ...
      "input": {
        "shape": "CreateWebACLMigrationStackRequest"
      },
      "output": {
        "shape": "CreateWebACLMigrationStackResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "CreateXssMatchSet": {
      ...
      "input": {
        "shape": "CreateXssMatchSetRequest"
      },
      "output": {
        "shape": "CreateXssMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFDisallowedNameException"
    ...
    "DeleteByteMatchSet": {
      ...
      "input": {
        "shape": "DeleteByteMatchSetRequest"
      },
      "output": {
        "shape": "DeleteByteMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "DeleteGeoMatchSet": {
      ...
      "input": {
        "shape": "DeleteGeoMatchSetRequest"
      },
      "output": {
        "shape": "DeleteGeoMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "DeleteRateBasedRule": {
      ...
      "input": {
        "shape": "DeleteRateBasedRuleRequest"
      },
      "output": {
        "shape": "DeleteRateBasedRuleResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "DeleteRegexMatchSet": {
      ...
      "input": {
        "shape": "DeleteRegexMatchSetRequest"
      },
      "output": {
        "shape": "DeleteRegexMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "DeleteSizeConstraintSet": {
      ...
      "input": {
        "shape": "DeleteSizeConstraintSetRequest"
      },
      "output": {
        "shape": "DeleteSizeConstraintSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "DeleteSqlInjectionMatchSet": {
      ...
      "input": {
        "shape": "DeleteSqlInjectionMatchSetRequest"
      },
      "output": {
        "shape": "DeleteSqlInjectionMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "DeleteXssMatchSet": {
      ...
      "input": {
        "shape": "DeleteXssMatchSetRequest"
      },
      "output": {
        "shape": "DeleteXssMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetByteMatchSet": {
      ...
      "input": {
        "shape": "GetByteMatchSetRequest"
      },
      "output": {
        "shape": "GetByteMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetChangeToken": {
      ...
      "input": {
        "shape": "GetChangeTokenRequest"
      },
      "output": {
        "shape": "GetChangeTokenResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetChangeTokenStatus": {
      ...
      "input": {
        "shape": "GetChangeTokenStatusRequest"
      },
      "output": {
        "shape": "GetChangeTokenStatusResponse"
      },
      "errors": [
        {
          "shape": "WAFNonexistentItemException"
    ...
    "GetGeoMatchSet": {
      ...
      "input": {
        "shape": "GetGeoMatchSetRequest"
      },
      "output": {
        "shape": "GetGeoMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetRateBasedRule": {
      ...
      "input": {
        "shape": "GetRateBasedRuleRequest"
      },
      "output": {
        "shape": "GetRateBasedRuleResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetRateBasedRuleManagedKeys": {
      ...
      "input": {
        "shape": "GetRateBasedRuleManagedKeysRequest"
      },
      "output": {
        "shape": "GetRateBasedRuleManagedKeysResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetRegexMatchSet": {
      ...
      "input": {
        "shape": "GetRegexMatchSetRequest"
      },
      "output": {
        "shape": "GetRegexMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetSizeConstraintSet": {
      ...
      "input": {
        "shape": "GetSizeConstraintSetRequest"
      },
      "output": {
        "shape": "GetSizeConstraintSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetSqlInjectionMatchSet": {
      ...
      "input": {
        "shape": "GetSqlInjectionMatchSetRequest"
      },
      "output": {
        "shape": "GetSqlInjectionMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "GetXssMatchSet": {
      ...
      "input": {
        "shape": "GetXssMatchSetRequest"
      },
      "output": {
        "shape": "GetXssMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListActivatedRulesInRuleGroup": {
      ...
      "input": {
        "shape": "ListActivatedRulesInRuleGroupRequest"
      },
      "output": {
        "shape": "ListActivatedRulesInRuleGroupResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListByteMatchSets": {
      ...
      "input": {
        "shape": "ListByteMatchSetsRequest"
      },
      "output": {
        "shape": "ListByteMatchSetsResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListGeoMatchSets": {
      ...
      "input": {
        "shape": "ListGeoMatchSetsRequest"
      },
      "output": {
        "shape": "ListGeoMatchSetsResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListRateBasedRules": {
      ...
      "input": {
        "shape": "ListRateBasedRulesRequest"
      },
      "output": {
        "shape": "ListRateBasedRulesResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListRegexMatchSets": {
      ...
      "input": {
        "shape": "ListRegexMatchSetsRequest"
      },
      "output": {
        "shape": "ListRegexMatchSetsResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListSizeConstraintSets": {
      ...
      "input": {
        "shape": "ListSizeConstraintSetsRequest"
      },
      "output": {
        "shape": "ListSizeConstraintSetsResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListSqlInjectionMatchSets": {
      ...
      "input": {
        "shape": "ListSqlInjectionMatchSetsRequest"
      },
      "output": {
        "shape": "ListSqlInjectionMatchSetsResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "ListSubscribedRuleGroups": {
      ...
      "input": {
        "shape": "ListSubscribedRuleGroupsRequest"
      },
      "output": {
        "shape": "ListSubscribedRuleGroupsResponse"
      },
      "errors": [
        {
          "shape": "WAFNonexistentItemException"
    ...
    "ListXssMatchSets": {
      ...
      "input": {
        "shape": "ListXssMatchSetsRequest"
      },
      "output": {
        "shape": "ListXssMatchSetsResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "UpdateByteMatchSet": {
      ...
      "input": {
        "shape": "UpdateByteMatchSetRequest"
      },
      "output": {
        "shape": "UpdateByteMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "UpdateGeoMatchSet": {
      ...
      "input": {
        "shape": "UpdateGeoMatchSetRequest"
      },
      "output": {
        "shape": "UpdateGeoMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "UpdateRateBasedRule": {
      ...
      "input": {
        "shape": "UpdateRateBasedRuleRequest"
      },
      "output": {
        "shape": "UpdateRateBasedRuleResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "UpdateRegexMatchSet": {
      ...
      "input": {
        "shape": "UpdateRegexMatchSetRequest"
      },
      "output": {
        "shape": "UpdateRegexMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "UpdateSizeConstraintSet": {
      ...
      "input": {
        "shape": "UpdateSizeConstraintSetRequest"
      },
      "output": {
        "shape": "UpdateSizeConstraintSetResponse"
      },
      "errors": [
        {
          "shape": "WAFStaleDataException"
    ...
    "UpdateSqlInjectionMatchSet": {
      ...
      "input": {
        "shape": "UpdateSqlInjectionMatchSetRequest"
      },
      "output": {
        "shape": "UpdateSqlInjectionMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
    ...
    "UpdateXssMatchSet": {
      ...
      "input": {
        "shape": "UpdateXssMatchSetRequest"
      },
      "output": {
        "shape": "UpdateXssMatchSetResponse"
      },
      "errors": [
        {
          "shape": "WAFInternalErrorException"
  ...
  "shapes": {
    ...
    "CreateGeoMatchSetRequest": {
      ...
      "members": {
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>GeoMatchSet</a>. You can't change <code>Name</code> after you create the <code>GeoMatchSet</code>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "CreateGeoMatchSetResponse": {
      ...
      "members": {
        "GeoMatchSet": {
          "shape": "GeoMatchSet",
          "documentation": "<p>The <a>GeoMatchSet</a> returned in the <code>CreateGeoMatchSet</code> response. The <code>GeoMatchSet</code> contains no <code>GeoMatchConstraints</code>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>CreateGeoMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "CreateIPSetRequest": {
    ...
    "CreateRateBasedRuleRequest": {
      ...
      "members": {
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RateBasedRule</a>. You can't change the name of a <code>RateBasedRule</code> after you create it.</p>"
        },
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for this <code>RateBasedRule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change the name of the metric after you create the <code>RateBasedRule</code>.</p>"
        },
        "RateKey": {
          "shape": "RateKey",
          "documentation": "<p>The field that AWS WAF uses to determine if requests are likely arriving from a single source and thus subject to rate monitoring. The only valid value for <code>RateKey</code> is <code>IP</code>. <code>IP</code> indicates that requests that arrive from the same IP address are subject to the <code>RateLimit</code> that is specified in the <code>RateBasedRule</code>.</p>"
        },
        "RateLimit": {
          "shape": "RateLimit",
          "documentation": "<p>The maximum number of requests, which have an identical value in the field that is specified by <code>RateKey</code>, allowed in a five-minute period. If the number of requests exceeds the <code>RateLimit</code> and the other predicates specified in the rule are also met, AWS WAF triggers the action that is specified for this rule.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>CreateRateBasedRule</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        },
        "Tags": {
          "shape": "TagList",
          "documentation": "<p/>"
    ...
    "CreateRateBasedRuleResponse": {
      ...
      "members": {
        "Rule": {
          "shape": "RateBasedRule",
          "documentation": "<p>The <a>RateBasedRule</a> that is returned in the <code>CreateRateBasedRule</code> response.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>CreateRateBasedRule</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
    ...
    "CreateRegexMatchSetRequest": {
      ...
      "members": {
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RegexMatchSet</a>. You can't change <code>Name</code> after you create a <code>RegexMatchSet</code>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "CreateRegexMatchSetResponse": {
      ...
      "members": {
        "RegexMatchSet": {
          "shape": "RegexMatchSet",
          "documentation": "<p>A <a>RegexMatchSet</a> that contains no <code>RegexMatchTuple</code> objects.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>CreateRegexMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "CreateRegexPatternSetRequest": {
      ...
      "members": {
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RegexPatternSet</a>. You can't change <code>Name</code> after you create a <code>RegexPatternSet</code>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "CreateRegexPatternSetResponse": {
      ...
      "members": {
        "RegexPatternSet": {
          ...
          "documentation": "<p>A <a>RegexPatternSet</a> that contains no objects.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>CreateRegexPatternSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "CreateRuleGroupRequest": {
      ...
      "members": {
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RuleGroup</a>. You can't change <code>Name</code> after you create a <code>RuleGroup</code>.</p>"
        },
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for this <code>RuleGroup</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change the name of the metric after you create the <code>RuleGroup</code>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "CreateRuleGroupResponse": {
      ...
      "members": {
        "RuleGroup": {
          "shape": "RuleGroup",
          "documentation": "<p>An empty <a>RuleGroup</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>CreateRuleGroup</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "CreateRuleRequest": {
      ...
      "members": {
        ...
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for this <code>Rule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change the name of the metric after you create the <code>Rule</code>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "CreateWebACLMigrationStackRequest": {
      ...
      "members": {
        "WebACLId": {
          "shape": "ResourceId",
          "documentation": "<p>The UUID of the WAF Classic web ACL that you want to migrate to WAF v2.</p>"
        },
        "S3BucketName": {
          "shape": "S3BucketName",
          "documentation": "<p>The name of the Amazon S3 bucket to store the CloudFormation template in. The S3 bucket must be configured as follows for the migration: </p> <ul> <li> <p>The bucket name must start with <code>aws-waf-migration-</code>. For example, <code>aws-waf-migration-my-web-acl</code>.</p> </li> <li> <p>The bucket must be in the Region where you are deploying the template. For example, for a web ACL in us-west-2, you must use an Amazon S3 bucket in us-west-2 and you must deploy the template stack to us-west-2. </p> </li> <li> <p>The bucket policies must permit the migration process to write data. For listings of the bucket policies, see the Examples section. </p> </li> </ul>"
        },
        "IgnoreUnsupportedType": {
          "shape": "IgnoreUnsupportedType",
          "documentation": "<p>Indicates whether to exclude entities that can't be migrated or to stop the migration. Set this to true to ignore unsupported entities in the web ACL during the migration. Otherwise, if AWS WAF encounters unsupported entities, it stops the process and throws an exception. </p>"
        }
      }
    },
    "CreateWebACLMigrationStackResponse": {
      ...
      "members": {
        "S3ObjectUrl": {
          "shape": "S3ObjectUrl",
          "documentation": "<p>The URL of the template created in Amazon S3. </p>"
        }
      }
    },
    "CreateWebACLRequest": {
      ...
      "members": {
        ...
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for this <code>WebACL</code>.The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change <code>MetricName</code> after you create the <code>WebACL</code>.</p>"
        },
        "DefaultAction": {
          "shape": "WafAction",
    ...
    "DeleteGeoMatchSetRequest": {
      ...
      "members": {
        "GeoMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>GeoMatchSetID</code> of the <a>GeoMatchSet</a> that you want to delete. <code>GeoMatchSetId</code> is returned by <a>CreateGeoMatchSet</a> and by <a>ListGeoMatchSets</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "DeleteGeoMatchSetResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>DeleteGeoMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "DeleteIPSetRequest": {
    ...
    "DeleteRateBasedRuleRequest": {
      ...
      "members": {
        "RuleId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleId</code> of the <a>RateBasedRule</a> that you want to delete. <code>RuleId</code> is returned by <a>CreateRateBasedRule</a> and by <a>ListRateBasedRules</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "DeleteRateBasedRuleResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>DeleteRateBasedRule</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "DeleteRegexMatchSetRequest": {
      ...
      "members": {
        "RegexMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexMatchSetId</code> of the <a>RegexMatchSet</a> that you want to delete. <code>RegexMatchSetId</code> is returned by <a>CreateRegexMatchSet</a> and by <a>ListRegexMatchSets</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "DeleteRegexMatchSetResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>DeleteRegexMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "DeleteRegexPatternSetRequest": {
      ...
      "members": {
        "RegexPatternSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexPatternSetId</code> of the <a>RegexPatternSet</a> that you want to delete. <code>RegexPatternSetId</code> is returned by <a>CreateRegexPatternSet</a> and by <a>ListRegexPatternSets</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "DeleteRegexPatternSetResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>DeleteRegexPatternSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "DeleteRuleGroupRequest": {
      ...
      "members": {
        "RuleGroupId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleGroupId</code> of the <a>RuleGroup</a> that you want to delete. <code>RuleGroupId</code> is returned by <a>CreateRuleGroup</a> and by <a>ListRuleGroups</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "DeleteRuleGroupResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>DeleteRuleGroup</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "DeleteRuleRequest": {
    ...
    "FieldToMatch": {
      ...
      "members": {
        ...
        "Data": {
          ...
          "documentation": "<p>When the value of <code>Type</code> is <code>HEADER</code>, enter the name of the header that you want AWS WAF to search, for example, <code>User-Agent</code> or <code>Referer</code>. The name of the header is not case sensitive.</p> <p>When the value of <code>Type</code> is <code>SINGLE_QUERY_ARG</code>, enter the name of the parameter that you want AWS WAF to search, for example, <code>UserName</code> or <code>SalesRegion</code>. The parameter name is not case sensitive.</p> <p>If the value of <code>Type</code> is any other value, omit <code>Data</code>.</p>"
        }
      },
    ...
    "GeoMatchConstraint": {
      ...
      "members": {
        "Type": {
          "shape": "GeoMatchConstraintType",
          "documentation": "<p>The type of geographical area you want AWS WAF to search for. Currently <code>Country</code> is the only valid value.</p>"
        },
        "Value": {
          "shape": "GeoMatchConstraintValue",
          "documentation": "<p>The country that you want AWS WAF to search for.</p>"
        }
      },
    ...
    "GeoMatchSet": {
      ...
      "members": {
        "GeoMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>GeoMatchSetId</code> for an <code>GeoMatchSet</code>. You use <code>GeoMatchSetId</code> to get information about a <code>GeoMatchSet</code> (see <a>GeoMatchSet</a>), update a <code>GeoMatchSet</code> (see <a>UpdateGeoMatchSet</a>), insert a <code>GeoMatchSet</code> into a <code>Rule</code> or delete one from a <code>Rule</code> (see <a>UpdateRule</a>), and delete a <code>GeoMatchSet</code> from AWS WAF (see <a>DeleteGeoMatchSet</a>).</p> <p> <code>GeoMatchSetId</code> is returned by <a>CreateGeoMatchSet</a> and by <a>ListGeoMatchSets</a>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>GeoMatchSet</a>. You can't change the name of an <code>GeoMatchSet</code> after you create it.</p>"
        },
        "GeoMatchConstraints": {
          "shape": "GeoMatchConstraints",
          "documentation": "<p>An array of <a>GeoMatchConstraint</a> objects, which contain the country that you want AWS WAF to search for.</p>"
        }
      },
    ...
    "GeoMatchSetSummary": {
      ...
      "members": {
        "GeoMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>GeoMatchSetId</code> for an <a>GeoMatchSet</a>. You can use <code>GeoMatchSetId</code> in a <a>GetGeoMatchSet</a> request to get detailed information about an <a>GeoMatchSet</a>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>GeoMatchSet</a>. You can't change the name of an <code>GeoMatchSet</code> after you create it.</p>"
    ...
    "GeoMatchSetUpdate": {
      ...
      "members": {
        "Action": {
          "shape": "ChangeAction",
          "documentation": "<p>Specifies whether to insert or delete a country with <a>UpdateGeoMatchSet</a>.</p>"
        },
        "GeoMatchConstraint": {
          "shape": "GeoMatchConstraint",
          "documentation": "<p>The country from which web requests originate that you want AWS WAF to search for.</p>"
        }
      },
    ...
    "GetGeoMatchSetRequest": {
      ...
      "members": {
        "GeoMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>GeoMatchSetId</code> of the <a>GeoMatchSet</a> that you want to get. <code>GeoMatchSetId</code> is returned by <a>CreateGeoMatchSet</a> and by <a>ListGeoMatchSets</a>.</p>"
        }
      }
    },
    "GetGeoMatchSetResponse": {
      ...
      "members": {
        "GeoMatchSet": {
          "shape": "GeoMatchSet",
          "documentation": "<p>Information about the <a>GeoMatchSet</a> that you specified in the <code>GetGeoMatchSet</code> request. This includes the <code>Type</code>, which for a <code>GeoMatchContraint</code> is always <code>Country</code>, as well as the <code>Value</code>, which is the identifier for a specific country.</p>"
        }
      }
    },
    "GetIPSetRequest": {
    ...
    "GetRateBasedRuleManagedKeysRequest": {
      ...
      "members": {
        "RuleId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleId</code> of the <a>RateBasedRule</a> for which you want to get a list of <code>ManagedKeys</code>. <code>RuleId</code> is returned by <a>CreateRateBasedRule</a> and by <a>ListRateBasedRules</a>.</p>"
        },
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>A null value and not currently used. Do not include this in your request.</p>"
        }
      }
    },
    "GetRateBasedRuleManagedKeysResponse": {
      ...
      "members": {
        "ManagedKeys": {
          "shape": "ManagedKeys",
          "documentation": "<p>An array of IP addresses that currently are blocked by the specified <a>RateBasedRule</a>. </p>"
        },
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>A null value and not currently used.</p>"
        }
      }
    },
    "GetRateBasedRuleRequest": {
      ...
      "members": {
        "RuleId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleId</code> of the <a>RateBasedRule</a> that you want to get. <code>RuleId</code> is returned by <a>CreateRateBasedRule</a> and by <a>ListRateBasedRules</a>.</p>"
        }
      }
    },
    "GetRateBasedRuleResponse": {
      ...
      "members": {
        "Rule": {
          "shape": "RateBasedRule",
          "documentation": "<p>Information about the <a>RateBasedRule</a> that you specified in the <code>GetRateBasedRule</code> request.</p>"
        }
      }
    },
    "GetRegexMatchSetRequest": {
      ...
      "members": {
        "RegexMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexMatchSetId</code> of the <a>RegexMatchSet</a> that you want to get. <code>RegexMatchSetId</code> is returned by <a>CreateRegexMatchSet</a> and by <a>ListRegexMatchSets</a>.</p>"
        }
      }
    },
    "GetRegexMatchSetResponse": {
      ...
      "members": {
        "RegexMatchSet": {
          "shape": "RegexMatchSet",
          "documentation": "<p>Information about the <a>RegexMatchSet</a> that you specified in the <code>GetRegexMatchSet</code> request. For more information, see <a>RegexMatchTuple</a>.</p>"
        }
      }
    },
    "GetRegexPatternSetRequest": {
      ...
      "members": {
        "RegexPatternSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexPatternSetId</code> of the <a>RegexPatternSet</a> that you want to get. <code>RegexPatternSetId</code> is returned by <a>CreateRegexPatternSet</a> and by <a>ListRegexPatternSets</a>.</p>"
        }
      }
    },
    "GetRegexPatternSetResponse": {
      ...
      "members": {
        "RegexPatternSet": {
          "shape": "RegexPatternSet",
          "documentation": "<p>Information about the <a>RegexPatternSet</a> that you specified in the <code>GetRegexPatternSet</code> request, including the identifier of the pattern set and the regular expression patterns you want AWS WAF to search for. </p>"
        }
      }
    },
    "GetRuleGroupRequest": {
      ...
      "members": {
        "RuleGroupId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleGroupId</code> of the <a>RuleGroup</a> that you want to get. <code>RuleGroupId</code> is returned by <a>CreateRuleGroup</a> and by <a>ListRuleGroups</a>.</p>"
        }
      }
    },
    "GetRuleGroupResponse": {
      ...
      "members": {
        "RuleGroup": {
          "shape": "RuleGroup",
          "documentation": "<p>Information about the <a>RuleGroup</a> that you specified in the <code>GetRuleGroup</code> request. </p>"
        }
      }
    },
    "GetRuleRequest": {
    ...
    "GetSampledRequestsRequest": {
      ...
      "members": {
        ...
        "MaxItems": {
          "shape": "GetSampledRequestsMaxItems",
    ...
    "ListActivatedRulesInRuleGroupRequest": {
      ...
      "members": {
        "RuleGroupId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleGroupId</code> of the <a>RuleGroup</a> for which you want to get a list of <a>ActivatedRule</a> objects.</p>"
        },
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>ActivatedRules</code> than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>ActivatedRules</code>. For the second and subsequent <code>ListActivatedRulesInRuleGroup</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>ActivatedRules</code>.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of <code>ActivatedRules</code> that you want AWS WAF to return for this request. If you have more <code>ActivatedRules</code> than the number that you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>ActivatedRules</code>.</p>"
        }
      }
    },
    "ListActivatedRulesInRuleGroupResponse": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more <code>ActivatedRules</code> than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more <code>ActivatedRules</code>, submit another <code>ListActivatedRulesInRuleGroup</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        },
        "ActivatedRules": {
          "shape": "ActivatedRules",
          "documentation": "<p>An array of <code>ActivatedRules</code> objects.</p>"
        }
      }
    },
    ...
    "ListGeoMatchSetsRequest": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>GeoMatchSet</code>s than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>GeoMatchSet</code> objects. For the second and subsequent <code>ListGeoMatchSets</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>GeoMatchSet</code> objects.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of <code>GeoMatchSet</code> objects that you want AWS WAF to return for this request. If you have more <code>GeoMatchSet</code> objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>GeoMatchSet</code> objects.</p>"
        }
      }
    },
    "ListGeoMatchSetsResponse": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more <code>GeoMatchSet</code> objects than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more <code>GeoMatchSet</code> objects, submit another <code>ListGeoMatchSets</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        },
        "GeoMatchSets": {
          "shape": "GeoMatchSetSummaries",
          "documentation": "<p>An array of <a>GeoMatchSetSummary</a> objects.</p>"
        }
      }
    },
    "ListIPSetsRequest": {
    ...
    "ListLoggingConfigurationsRequest": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>LoggingConfigurations</code> than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>LoggingConfigurations</code>. For the second and subsequent <code>ListLoggingConfigurations</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>ListLoggingConfigurations</code>.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of <code>LoggingConfigurations</code> that you want AWS WAF to return for this request. If you have more <code>LoggingConfigurations</code> than the number that you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>LoggingConfigurations</code>.</p>"
        }
      }
    },
    "ListLoggingConfigurationsResponse": {
      ...
      "members": {
        "LoggingConfigurations": {
          ...
          "documentation": "<p>An array of <a>LoggingConfiguration</a> objects.</p>"
        },
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more <code>LoggingConfigurations</code> than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more <code>LoggingConfigurations</code>, submit another <code>ListLoggingConfigurations</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        }
      }
    },
    ...
    "ListRegexMatchSetsRequest": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>RegexMatchSet</code> objects than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>ByteMatchSets</code>. For the second and subsequent <code>ListRegexMatchSets</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>RegexMatchSet</code> objects.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of <code>RegexMatchSet</code> objects that you want AWS WAF to return for this request. If you have more <code>RegexMatchSet</code> objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>RegexMatchSet</code> objects.</p>"
        }
      }
    },
    "ListRegexMatchSetsResponse": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more <code>RegexMatchSet</code> objects than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more <code>RegexMatchSet</code> objects, submit another <code>ListRegexMatchSets</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        },
        "RegexMatchSets": {
          "shape": "RegexMatchSetSummaries",
          "documentation": "<p>An array of <a>RegexMatchSetSummary</a> objects.</p>"
        }
      }
    },
    "ListRegexPatternSetsRequest": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>RegexPatternSet</code> objects than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>RegexPatternSet</code> objects. For the second and subsequent <code>ListRegexPatternSets</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>RegexPatternSet</code> objects.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of <code>RegexPatternSet</code> objects that you want AWS WAF to return for this request. If you have more <code>RegexPatternSet</code> objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>RegexPatternSet</code> objects.</p>"
        }
      }
    },
    "ListRegexPatternSetsResponse": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more <code>RegexPatternSet</code> objects than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more <code>RegexPatternSet</code> objects, submit another <code>ListRegexPatternSets</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        },
        "RegexPatternSets": {
          "shape": "RegexPatternSetSummaries",
          "documentation": "<p>An array of <a>RegexPatternSetSummary</a> objects.</p>"
        }
      }
    },
    "ListResourcesForWebACLRequest": {
      ...
      "members": {
        ...
        "ResourceType": {
          "shape": "ResourceType",
          "documentation": "<p>The type of resource to list, either an application load balancer or Amazon API Gateway.</p>"
        }
      }
    },
    ...
    "ListRuleGroupsRequest": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>RuleGroups</code> than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>RuleGroups</code>. For the second and subsequent <code>ListRuleGroups</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>RuleGroups</code>.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of <code>RuleGroups</code> that you want AWS WAF to return for this request. If you have more <code>RuleGroups</code> than the number that you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>RuleGroups</code>.</p>"
        }
      }
    },
    "ListRuleGroupsResponse": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more <code>RuleGroups</code> than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more <code>RuleGroups</code>, submit another <code>ListRuleGroups</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        },
        "RuleGroups": {
          "shape": "RuleGroupSummaries",
          "documentation": "<p>An array of <a>RuleGroup</a> objects.</p>"
        }
      }
    },
    "ListRulesRequest": {
    ...
    "ListSubscribedRuleGroupsRequest": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you specify a value for <code>Limit</code> and you have more <code>ByteMatchSets</code>subscribed rule groups than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of subscribed rule groups. For the second and subsequent <code>ListSubscribedRuleGroupsRequest</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of subscribed rule groups.</p>"
        },
        "Limit": {
          "shape": "PaginationLimit",
          "documentation": "<p>Specifies the number of subscribed rule groups that you want AWS WAF to return for this request. If you have more objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of objects.</p>"
        }
      }
    },
    "ListSubscribedRuleGroupsResponse": {
      ...
      "members": {
        "NextMarker": {
          "shape": "NextMarker",
          "documentation": "<p>If you have more objects than the number that you specified for <code>Limit</code> in the request, the response includes a <code>NextMarker</code> value. To list more objects, submit another <code>ListSubscribedRuleGroups</code> request, and specify the <code>NextMarker</code> value from the response in the <code>NextMarker</code> value in the next request.</p>"
        },
        "RuleGroups": {
          "shape": "SubscribedRuleGroupSummaries",
          "documentation": "<p>An array of <a>RuleGroup</a> objects.</p>"
        }
      }
    },
    ...
    "Predicate": {
      ...
      "members": {
        ...
        "Type": {
          "shape": "PredicateType",
          "documentation": "<p>The type of predicate in a <code>Rule</code>, such as <code>ByteMatch</code> or <code>IPSet</code>.</p>"
        },
        "DataId": {
          "shape": "ResourceId",
    ...
    "PutLoggingConfigurationResponse": {
      ...
      "members": {
        "LoggingConfiguration": {
          "shape": "LoggingConfiguration",
          "documentation": "<p>The <a>LoggingConfiguration</a> that you submitted in the request.</p>"
        }
      }
    },
    ...
    "RateBasedRule": {
      ...
      "members": {
        "RuleId": {
          "shape": "ResourceId",
          "documentation": "<p>A unique identifier for a <code>RateBasedRule</code>. You use <code>RuleId</code> to get more information about a <code>RateBasedRule</code> (see <a>GetRateBasedRule</a>), update a <code>RateBasedRule</code> (see <a>UpdateRateBasedRule</a>), insert a <code>RateBasedRule</code> into a <code>WebACL</code> or delete one from a <code>WebACL</code> (see <a>UpdateWebACL</a>), or delete a <code>RateBasedRule</code> from AWS WAF (see <a>DeleteRateBasedRule</a>).</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description for a <code>RateBasedRule</code>. You can't change the name of a <code>RateBasedRule</code> after you create it.</p>"
        },
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for a <code>RateBasedRule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change the name of the metric after you create the <code>RateBasedRule</code>.</p>"
        },
        "MatchPredicates": {
          "shape": "Predicates",
          "documentation": "<p>The <code>Predicates</code> object contains one <code>Predicate</code> element for each <a>ByteMatchSet</a>, <a>IPSet</a>, or <a>SqlInjectionMatchSet</a> object that you want to include in a <code>RateBasedRule</code>.</p>"
        },
        "RateKey": {
          "shape": "RateKey",
          "documentation": "<p>The field that AWS WAF uses to determine if requests are likely arriving from single source and thus subject to rate monitoring. The only valid value for <code>RateKey</code> is <code>IP</code>. <code>IP</code> indicates that requests arriving from the same IP address are subject to the <code>RateLimit</code> that is specified in the <code>RateBasedRule</code>.</p>"
        },
        "RateLimit": {
          "shape": "RateLimit",
          "documentation": "<p>The maximum number of requests, which have an identical value in the field specified by the <code>RateKey</code>, allowed in a five-minute period. If the number of requests exceeds the <code>RateLimit</code> and the other predicates specified in the rule are also met, AWS WAF triggers the action that is specified for this rule.</p>"
        }
      },
    ...
    "RegexMatchSet": {
      ...
      "members": {
        "RegexMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexMatchSetId</code> for a <code>RegexMatchSet</code>. You use <code>RegexMatchSetId</code> to get information about a <code>RegexMatchSet</code> (see <a>GetRegexMatchSet</a>), update a <code>RegexMatchSet</code> (see <a>UpdateRegexMatchSet</a>), insert a <code>RegexMatchSet</code> into a <code>Rule</code> or delete one from a <code>Rule</code> (see <a>UpdateRule</a>), and delete a <code>RegexMatchSet</code> from AWS WAF (see <a>DeleteRegexMatchSet</a>).</p> <p> <code>RegexMatchSetId</code> is returned by <a>CreateRegexMatchSet</a> and by <a>ListRegexMatchSets</a>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RegexMatchSet</a>. You can't change <code>Name</code> after you create a <code>RegexMatchSet</code>.</p>"
    ...
    "RegexMatchSetSummary": {
      ...
      "members": {
        "RegexMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexMatchSetId</code> for a <code>RegexMatchSet</code>. You use <code>RegexMatchSetId</code> to get information about a <code>RegexMatchSet</code>, update a <code>RegexMatchSet</code>, remove a <code>RegexMatchSet</code> from a <code>Rule</code>, and delete a <code>RegexMatchSet</code> from AWS WAF.</p> <p> <code>RegexMatchSetId</code> is returned by <a>CreateRegexMatchSet</a> and by <a>ListRegexMatchSets</a>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RegexMatchSet</a>. You can't change <code>Name</code> after you create a <code>RegexMatchSet</code>.</p>"
    ...
    "RegexMatchSetUpdate": {
      ...
      "members": {
        "Action": {
          "shape": "ChangeAction",
          "documentation": "<p>Specifies whether to insert or delete a <a>RegexMatchTuple</a>.</p>"
        },
        "RegexMatchTuple": {
          "shape": "RegexMatchTuple",
    ...
    "RegexMatchTuple": {
      ...
      "members": {
        "FieldToMatch": {
          "shape": "FieldToMatch",
          "documentation": "<p>Specifies where in a web request to look for the <code>RegexPatternSet</code>.</p>"
        },
        "TextTransformation": {
          "shape": "TextTransformation",
        ...
        "RegexPatternSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexPatternSetId</code> for a <code>RegexPatternSet</code>. You use <code>RegexPatternSetId</code> to get information about a <code>RegexPatternSet</code> (see <a>GetRegexPatternSet</a>), update a <code>RegexPatternSet</code> (see <a>UpdateRegexPatternSet</a>), insert a <code>RegexPatternSet</code> into a <code>RegexMatchSet</code> or delete one from a <code>RegexMatchSet</code> (see <a>UpdateRegexMatchSet</a>), and delete an <code>RegexPatternSet</code> from AWS WAF (see <a>DeleteRegexPatternSet</a>).</p> <p> <code>RegexPatternSetId</code> is returned by <a>CreateRegexPatternSet</a> and by <a>ListRegexPatternSets</a>.</p>"
        }
      },
    ...
    "RegexPatternSet": {
      ...
      "members": {
        "RegexPatternSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The identifier for the <code>RegexPatternSet</code>. You use <code>RegexPatternSetId</code> to get information about a <code>RegexPatternSet</code>, update a <code>RegexPatternSet</code>, remove a <code>RegexPatternSet</code> from a <code>RegexMatchSet</code>, and delete a <code>RegexPatternSet</code> from AWS WAF.</p> <p> <code>RegexMatchSetId</code> is returned by <a>CreateRegexPatternSet</a> and by <a>ListRegexPatternSets</a>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RegexPatternSet</a>. You can't change <code>Name</code> after you create a <code>RegexPatternSet</code>.</p>"
        ...
        "RegexPatternStrings": {
          "shape": "RegexPatternStrings",
          "documentation": "<p>Specifies the regular expression (regex) patterns that you want AWS WAF to search for, such as <code>B[a@]dB[o0]t</code>.</p>"
        }
      },
    ...
    "RegexPatternSetSummary": {
      ...
      "members": {
        "RegexPatternSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexPatternSetId</code> for a <code>RegexPatternSet</code>. You use <code>RegexPatternSetId</code> to get information about a <code>RegexPatternSet</code>, update a <code>RegexPatternSet</code>, remove a <code>RegexPatternSet</code> from a <code>RegexMatchSet</code>, and delete a <code>RegexPatternSet</code> from AWS WAF.</p> <p> <code>RegexPatternSetId</code> is returned by <a>CreateRegexPatternSet</a> and by <a>ListRegexPatternSets</a>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RegexPatternSet</a>. You can't change <code>Name</code> after you create a <code>RegexPatternSet</code>.</p>"
    ...
    "RegexPatternSetUpdate": {
      ...
      "members": {
        "Action": {
          "shape": "ChangeAction",
          "documentation": "<p>Specifies whether to insert or delete a <code>RegexPatternString</code>.</p>"
        },
        "RegexPatternString": {
          "shape": "RegexPatternString",
          "documentation": "<p>Specifies the regular expression (regex) pattern that you want AWS WAF to search for, such as <code>B[a@]dB[o0]t</code>.</p>"
        }
      },
    ...
    "Rule": {
      ...
      "members": {
        ...
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for this <code>Rule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change <code>MetricName</code> after you create the <code>Rule</code>.</p>"
        },
        "Predicates": {
          "shape": "Predicates",
    ...
    "RuleGroupSummary": {
      ...
      "members": {
        ...
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <a>RuleGroup</a>. You can't change the name of a <code>RuleGroup</code> after you create it.</p>"
        }
      },
    ...
    "RuleGroupUpdate": {
      ...
      "members": {
        "Action": {
          "shape": "ChangeAction",
          "documentation": "<p>Specify <code>INSERT</code> to add an <code>ActivatedRule</code> to a <code>RuleGroup</code>. Use <code>DELETE</code> to remove an <code>ActivatedRule</code> from a <code>RuleGroup</code>.</p>"
        },
        "ActivatedRule": {
          "shape": "ActivatedRule",
          "documentation": "<p>The <code>ActivatedRule</code> object specifies a <code>Rule</code> that you want to insert or delete, the priority of the <code>Rule</code> in the <code>WebACL</code>, and the action that you want AWS WAF to take when a web request matches the <code>Rule</code> (<code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>).</p>"
        }
      },
    ...
    "SampledHTTPRequest": {
      ...
      "members": {
        ...
        "RuleWithinRuleGroup": {
          "shape": "ResourceId",
          "documentation": "<p>This value is returned if the <code>GetSampledRequests</code> request specifies the ID of a <code>RuleGroup</code> rather than the ID of an individual rule. <code>RuleWithinRuleGroup</code> is the rule within the specified <code>RuleGroup</code> that matched the request listed in the response.</p>"
        }
      },
    ...
    "SizeConstraint": {
      ...
      "members": {
        "FieldToMatch": {
          "shape": "FieldToMatch",
          "documentation": "<p>Specifies where in a web request to look for the size constraint.</p>"
        },
        "TextTransformation": {
          "shape": "TextTransformation",
    ...
    "SizeConstraintSetSummaries": {
      "type": "list",
      "member": {
        "shape": "SizeConstraintSetSummary"
      }
    },
    ...
    "SqlInjectionMatchSetSummaries": {
      "type": "list",
      "member": {
        "shape": "SqlInjectionMatchSetSummary"
      }
    },
    ...
    "SqlInjectionMatchSetUpdates": {
      "type": "list",
      "member": {
        "shape": "SqlInjectionMatchSetUpdate"
      },
      "min": 1
    },
    "SqlInjectionMatchTuple": {
      ...
      "members": {
        "FieldToMatch": {
          "shape": "FieldToMatch",
          "documentation": "<p>Specifies where in a web request to look for snippets of malicious SQL code.</p>"
        },
        "TextTransformation": {
          "shape": "TextTransformation",
          "documentation": "<p>Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on <code>FieldToMatch</code> before inspecting it for a match.</p> <p>You can only specify a single type of TextTransformation.</p> <p> <b>CMD_LINE</b> </p> <p>When you're concerned that attackers are injecting an operating system command line command and using unusual formatting to disguise some or all of the command, use this option to perform the following transformations:</p> <ul> <li> <p>Delete the following characters: \\ \" ' ^</p> </li> <li> <p>Delete spaces before the following characters: / (</p> </li> <li> <p>Replace the following characters with a space: , ;</p> </li> <li> <p>Replace multiple spaces with one space</p> </li> <li> <p>Convert uppercase letters (A-Z) to lowercase (a-z)</p> </li> </ul> <p> <b>COMPRESS_WHITE_SPACE</b> </p> <p>Use this option to replace the following characters with a space character (decimal 32):</p> <ul> <li> <p>\\f, formfeed, decimal 12</p> </li> <li> <p>\\t, tab, decimal 9</p> </li> <li> <p>\\n, newline, decimal 10</p> </li> <li> <p>\\r, carriage return, decimal 13</p> </li> <li> <p>\\v, vertical tab, decimal 11</p> </li> <li> <p>non-breaking space, decimal 160</p> </li> </ul> <p> <code>COMPRESS_WHITE_SPACE</code> also replaces multiple spaces with one space.</p> <p> <b>HTML_ENTITY_DECODE</b> </p> <p>Use this option to replace HTML-encoded characters with unencoded characters. <code>HTML_ENTITY_DECODE</code> performs the following operations:</p> <ul> <li> <p>Replaces <code>(ampersand)quot;</code> with <code>\"</code> </p> </li> <li> <p>Replaces <code>(ampersand)nbsp;</code> with a non-breaking space, decimal 160</p> </li> <li> <p>Replaces <code>(ampersand)lt;</code> with a \"less than\" symbol</p> </li> <li> <p>Replaces <code>(ampersand)gt;</code> with <code>&gt;</code> </p> </li> <li> <p>Replaces characters that are represented in hexadecimal format, <code>(ampersand)#xhhhh;</code>, with the corresponding characters</p> </li> <li> <p>Replaces characters that are represented in decimal format, <code>(ampersand)#nnnn;</code>, with the corresponding characters</p> </li> </ul> <p> <b>LOWERCASE</b> </p> <p>Use this option to convert uppercase letters (A-Z) to lowercase (a-z).</p> <p> <b>URL_DECODE</b> </p> <p>Use this option to decode a URL-encoded value.</p> <p> <b>NONE</b> </p> <p>Specify <code>NONE</code> if you don't want to perform any text transformations.</p>"
    ...
    "SubscribedRuleGroupSummaries": {
      "type": "list",
      "member": {
        "shape": "SubscribedRuleGroupSummary"
      }
    },
    "SubscribedRuleGroupSummary": {
      ...
      "members": {
        "RuleGroupId": {
          "shape": "ResourceId",
          "documentation": "<p>A unique identifier for a <code>RuleGroup</code>.</p>"
        },
        "Name": {
          "shape": "ResourceName",
          "documentation": "<p>A friendly name or description of the <code>RuleGroup</code>. You can't change the name of a <code>RuleGroup</code> after you create it.</p>"
        },
        "MetricName": {
          "shape": "MetricName",
          "documentation": "<p>A friendly name or description for the metrics for this <code>RuleGroup</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including \"All\" and \"Default_Action.\" You can't change the name of the metric after you create the <code>RuleGroup</code>.</p>"
    ...
    "UpdateGeoMatchSetRequest": {
      ...
      "members": {
        "GeoMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>GeoMatchSetId</code> of the <a>GeoMatchSet</a> that you want to update. <code>GeoMatchSetId</code> is returned by <a>CreateGeoMatchSet</a> and by <a>ListGeoMatchSets</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "UpdateGeoMatchSetResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>UpdateGeoMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "UpdateIPSetRequest": {
      ...
      "members": {
        ...
        "Updates": {
          "shape": "IPSetUpdates",
          "documentation": "<p>An array of <code>IPSetUpdate</code> objects that you want to insert into or delete from an <a>IPSet</a>. For more information, see the applicable data types:</p> <ul> <li> <p> <a>IPSetUpdate</a>: Contains <code>Action</code> and <code>IPSetDescriptor</code> </p> </li> <li> <p> <a>IPSetDescriptor</a>: Contains <code>Type</code> and <code>Value</code> </p> </li> </ul> <p>You can insert a maximum of 1000 addresses in a single request.</p>"
        }
      }
    },
    "UpdateIPSetResponse": {
    ...
    "UpdateRateBasedRuleRequest": {
      ...
      "members": {
        "RuleId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleId</code> of the <code>RateBasedRule</code> that you want to update. <code>RuleId</code> is returned by <code>CreateRateBasedRule</code> and by <a>ListRateBasedRules</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
        ...
        "Updates": {
          "shape": "RuleUpdates",
          "documentation": "<p>An array of <code>RuleUpdate</code> objects that you want to insert into or delete from a <a>RateBasedRule</a>. </p>"
        },
        "RateLimit": {
          "shape": "RateLimit",
          "documentation": "<p>The maximum number of requests, which have an identical value in the field specified by the <code>RateKey</code>, allowed in a five-minute period. If the number of requests exceeds the <code>RateLimit</code> and the other predicates specified in the rule are also met, AWS WAF triggers the action that is specified for this rule.</p>"
    ...
    "UpdateRateBasedRuleResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>UpdateRateBasedRule</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "UpdateRegexMatchSetRequest": {
      ...
      "members": {
        "RegexMatchSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexMatchSetId</code> of the <a>RegexMatchSet</a> that you want to update. <code>RegexMatchSetId</code> is returned by <a>CreateRegexMatchSet</a> and by <a>ListRegexMatchSets</a>.</p>"
        },
        "Updates": {
          "shape": "RegexMatchSetUpdates",
          "documentation": "<p>An array of <code>RegexMatchSetUpdate</code> objects that you want to insert into or delete from a <a>RegexMatchSet</a>. For more information, see <a>RegexMatchTuple</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "UpdateRegexMatchSetResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>UpdateRegexMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "UpdateRegexPatternSetRequest": {
      ...
      "members": {
        "RegexPatternSetId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RegexPatternSetId</code> of the <a>RegexPatternSet</a> that you want to update. <code>RegexPatternSetId</code> is returned by <a>CreateRegexPatternSet</a> and by <a>ListRegexPatternSets</a>.</p>"
        },
        "Updates": {
          "shape": "RegexPatternSetUpdates",
          "documentation": "<p>An array of <code>RegexPatternSetUpdate</code> objects that you want to insert into or delete from a <a>RegexPatternSet</a>.</p>"
        },
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The value returned by the most recent call to <a>GetChangeToken</a>.</p>"
    ...
    "UpdateRegexPatternSetResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>UpdateRegexPatternSet</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "UpdateRuleGroupRequest": {
      ...
      "members": {
        "RuleGroupId": {
          "shape": "ResourceId",
          "documentation": "<p>The <code>RuleGroupId</code> of the <a>RuleGroup</a> that you want to update. <code>RuleGroupId</code> is returned by <a>CreateRuleGroup</a> and by <a>ListRuleGroups</a>.</p>"
        },
        "Updates": {
    ...
    "UpdateRuleGroupResponse": {
      ...
      "members": {
        "ChangeToken": {
          "shape": "ChangeToken",
          "documentation": "<p>The <code>ChangeToken</code> that you used to submit the <code>UpdateRuleGroup</code> request. You can also use this value to query the status of the request. For more information, see <a>GetChangeTokenStatus</a>.</p>"
        }
      }
    },
    "UpdateRuleRequest": {
    ...
    "UpdateWebACLRequest": {
      ...
      "members": {
        ...
        "DefaultAction": {
          "shape": "WafAction",
          "documentation": "<p>A default action for the web ACL, either ALLOW or BLOCK. AWS WAF performs the default action if a request doesn't match the criteria in any of the rules in a web ACL.</p>"
        }
      }
    },
    ...
    "UpdateXssMatchSetRequest": {
      ...
      "members": {
        ...
        "Updates": {
          ...
          "documentation": "<p>An array of <code>XssMatchSetUpdate</code> objects that you want to insert into or delete from an <a>XssMatchSet</a>. For more information, see the applicable data types:</p> <ul> <li> <p> <a>XssMatchSetUpdate</a>: Contains <code>Action</code> and <code>XssMatchTuple</code> </p> </li> <li> <p> <a>XssMatchTuple</a>: Contains <code>FieldToMatch</code> and <code>TextTransformation</code> </p> </li> <li> <p> <a>FieldToMatch</a>: Contains <code>Data</code> and <code>Type</code> </p> </li> </ul>"
        }
      },
    ...
    "WafOverrideAction": {
      ...
      "members": {
        "Type": {
          "shape": "WafOverrideActionType",
          "documentation": "<p> <code>COUNT</code> overrides the action specified by the individual rule within a <code>RuleGroup</code> . If set to <code>NONE</code>, the rule's action will take place.</p>"
        }
      },
    ...
    "XssMatchSetUpdate": {
      ...
      "members": {
        "Action": {
          "shape": "ChangeAction",
          "documentation": "<p>Specify <code>INSERT</code> to add an <a>XssMatchSetUpdate</a> to an <a>XssMatchSet</a>. Use <code>DELETE</code> to remove an <code>XssMatchSetUpdate</code> from an <code>XssMatchSet</code>.</p>"
        },
        "XssMatchTuple": {
          "shape": "XssMatchTuple",
    ...
    "XssMatchTuple": {
      ...
      "members": {
        "FieldToMatch": {
          "shape": "FieldToMatch",
          "documentation": "<p>Specifies where in a web request to look for cross-site scripting attacks.</p>"
        },
        "TextTransformation": {
          "shape": "TextTransformation",
          "documentation": "<p>Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the transformation on <code>FieldToMatch</code> before inspecting it for a match.</p> <p>You can only specify a single type of TextTransformation.</p> <p> <b>CMD_LINE</b> </p> <p>When you're concerned that attackers are injecting an operating system command line command and using unusual formatting to disguise some or all of the command, use this option to perform the following transformations:</p> <ul> <li> <p>Delete the following characters: \\ \" ' ^</p> </li> <li> <p>Delete spaces before the following characters: / (</p> </li> <li> <p>Replace the following characters with a space: , ;</p> </li> <li> <p>Replace multiple spaces with one space</p> </li> <li> <p>Convert uppercase letters (A-Z) to lowercase (a-z)</p> </li> </ul> <p> <b>COMPRESS_WHITE_SPACE</b> </p> <p>Use this option to replace the following characters with a space character (decimal 32):</p> <ul> <li> <p>\\f, formfeed, decimal 12</p> </li> <li> <p>\\t, tab, decimal 9</p> </li> <li> <p>\\n, newline, decimal 10</p> </li> <li> <p>\\r, carriage return, decimal 13</p> </li> <li> <p>\\v, vertical tab, decimal 11</p> </li> <li> <p>non-breaking space, decimal 160</p> </li> </ul> <p> <code>COMPRESS_WHITE_SPACE</code> also replaces multiple spaces with one space.</p> <p> <b>HTML_ENTITY_DECODE</b> </p> <p>Use this option to replace HTML-encoded characters with unencoded characters. <code>HTML_ENTITY_DECODE</code> performs the following operations:</p> <ul> <li> <p>Replaces <code>(ampersand)quot;</code> with <code>\"</code> </p> </li> <li> <p>Replaces <code>(ampersand)nbsp;</code> with a non-breaking space, decimal 160</p> </li> <li> <p>Replaces <code>(ampersand)lt;</code> with a \"less than\" symbol</p> </li> <li> <p>Replaces <code>(ampersand)gt;</code> with <code>&gt;</code> </p> </li> <li> <p>Replaces characters that are represented in hexadecimal format, <code>(ampersand)#xhhhh;</code>, with the corresponding characters</p> </li> <li> <p>Replaces characters that are represented in decimal format, <code>(ampersand)#nnnn;</code>, with the corresponding characters</p> </li> </ul> <p> <b>LOWERCASE</b> </p> <p>Use this option to convert uppercase letters (A-Z) to lowercase (a-z).</p> <p> <b>URL_DECODE</b> </p> <p>Use this option to decode a URL-encoded value.</p> <p> <b>NONE</b> </p> <p>Specify <code>NONE</code> if you don't want to perform any text transformations.</p>"
