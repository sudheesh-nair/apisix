...
return assert(decode([===[
{
  ...
  "operations": {
    "CancelDataRepositoryTask": {
      ...
      "input": {
        "shape": "CancelDataRepositoryTaskRequest"
      },
      "output": {
        "shape": "CancelDataRepositoryTaskResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
    ...
    "CreateDataRepositoryTask": {
      ...
      "input": {
        "shape": "CreateDataRepositoryTaskRequest"
      },
      "output": {
        "shape": "CreateDataRepositoryTaskResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
    ...
    "CreateFileSystem": {
      ...
      "output": {
        "shape": "CreateFileSystemResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
    ...
    "CreateFileSystemFromBackup": {
      ...
      "input": {
        "shape": "CreateFileSystemFromBackupRequest"
      },
      "output": {
        "shape": "CreateFileSystemFromBackupResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
    ...
    "DeleteFileSystem": {
      ...
      "output": {
        "shape": "DeleteFileSystemResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
    ...
    "DescribeDataRepositoryTasks": {
      ...
      "input": {
        "shape": "DescribeDataRepositoryTasksRequest"
      },
      "output": {
        "shape": "DescribeDataRepositoryTasksResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
    ...
    "UpdateFileSystem": {
      ...
      "output": {
        "shape": "UpdateFileSystemResponse"
      },
      "errors": [
        {
          "shape": "BadRequest"
  ...
  "shapes": {
    ...
    "AdministrativeAction": {
      ...
      "members": {
        "AdministrativeActionType": {
          "shape": "AdministrativeActionType"
        },
        "ProgressPercent": {
        ...
        "FailureDetails": {
          "shape": "AdministrativeActionFailureDetails"
        }
      },
    ...
    "Backup": {
      ...
      "members": {
        ...
        "Lifecycle": {
          ...
          "documentation": "<p>The lifecycle status of the backup.</p> <ul> <li> <p> <code>AVAILABLE</code> - The backup is fully available.</p> </li> <li> <p> <code>CREATING</code> - FSx is creating the backup.</p> </li> <li> <p> <code>TRANSFERRING</code> - For Lustre file systems only; FSx is transferring the backup to S3.</p> </li> <li> <p> <code>DELETED</code> - The backup was deleted is no longer available.</p> </li> <li> <p> <code>FAILED</code> - Amazon FSx could not complete the backup.</p> </li> </ul>"
        },
        "FailureDetails": {
        ...
        "KmsKeyId": {
          "shape": "KmsKeyId",
          "documentation": "<p>The ID of the AWS Key Management Service (AWS KMS) key used to encrypt the backup of the Amazon FSx file system's data at rest. </p>"
        },
        "ResourceARN": {
          "shape": "ResourceARN",
    ...
    "BackupLifecycle": {
      "type": "string",
      "documentation": "<p>The lifecycle status of the backup.</p> <ul> <li> <p> <code>AVAILABLE</code> - The backup is fully available.</p> </li> <li> <p> <code>CREATING</code> - FSx is creating the new user-intiated backup</p> </li> <li> <p> <code>TRANSFERRING</code> - For user-initiated backups on Lustre file systems only; FSx is backing up the file system.</p> </li> <li> <p> <code>DELETED</code> - The backup was deleted is no longer available.</p> </li> <li> <p> <code>FAILED</code> - Amazon FSx could not complete the backup.</p> </li> </ul>",
      "enum": [
        "AVAILABLE",
        "CREATING",
        "TRANSFERRING",
    ...
    "Backups": {
      ...
      "documentation": "<p>A list of file system backups.</p>",
      "max": 50
    },
    ...
    "CreateFileSystemLustreConfiguration": {
      ...
      "members": {
        "WeeklyMaintenanceStartTime": {
          "shape": "WeeklyTime",
          "documentation": "<p>(Optional) The preferred start time to perform weekly maintenance, formatted d:HH:MM in the UTC time zone, where d is the weekday number, from 1 through 7, beginning with Monday and ending with Sunday.</p>"
        },
        "ImportPath": {
          "shape": "ArchivePath",
    ...
    "CreateFileSystemRequest": {
      ...
      "members": {
        ...
        "StorageCapacity": {
          ...
          "documentation": "<p>Sets the storage capacity of the file system that you're creating.</p> <p>For Lustre file systems:</p> <ul> <li> <p>For <code>SCRATCH_2</code> and <code>PERSISTENT_1 SSD</code> deployment types, valid values are 1200 GiB, 2400 GiB, and increments of 2400 GiB.</p> </li> <li> <p>For <code>PERSISTENT HDD</code> file systems, valid values are increments of 6000 GiB for 12 MB/s/TiB file systems and increments of 1800 GiB for 40 MB/s/TiB file systems.</p> </li> <li> <p>For <code>SCRATCH_1</code> deployment type, valid values are 1200 GiB, 2400 GiB, and increments of 3600 GiB.</p> </li> </ul> <p>For Windows file systems:</p> <ul> <li> <p>If <code>StorageType=SSD</code>, valid values are 32 GiB - 65,536 GiB (64 TiB).</p> </li> <li> <p>If <code>StorageType=HDD</code>, valid values are 2000 GiB - 65,536 GiB (64 TiB).</p> </li> </ul>"
        },
        "StorageType": {
          "shape": "StorageType",
    ...
    "CreateFileSystemWindowsConfiguration": {
      ...
      "members": {
        ...
        "SelfManagedActiveDirectoryConfiguration": {
          "shape": "SelfManagedActiveDirectoryConfiguration"
        },
        "DeploymentType": {
    ...
    "DataRepositoryTaskFilterValues": {
      "type": "list",
      "member": {
        "shape": "DataRepositoryTaskFilterValue"
      },
      "max": 20
    },
    "DataRepositoryTaskFilters": {
      "type": "list",
      "member": {
        "shape": "DataRepositoryTaskFilter"
      },
      "max": 3
    },
    ...
    "DeleteFileSystemRequest": {
      ...
      "members": {
        ...
        "WindowsConfiguration": {
          "shape": "DeleteFileSystemWindowsConfiguration"
        },
        "LustreConfiguration": {
    ...
    "DeleteFileSystemResponse": {
      ...
      "members": {
        ...
        "WindowsResponse": {
          "shape": "DeleteFileSystemWindowsResponse"
        },
        "LustreResponse": {
          "shape": "DeleteFileSystemLustreResponse"
        }
      },
    ...
    "FileSystem": {
      ...
      "members": {
        ...
        "FailureDetails": {
          "shape": "FileSystemFailureDetails"
        },
        "StorageCapacity": {
          "shape": "StorageCapacity",
        ...
        "LustreConfiguration": {
          "shape": "LustreFileSystemConfiguration"
        },
        "AdministrativeActions": {
    ...
    "FileSystemMaintenanceOperations": {
      "type": "list",
      "member": {
        "shape": "FileSystemMaintenanceOperation"
      },
    ...
    "LustreFileSystemConfiguration": {
      ...
      "members": {
        ...
        "DataRepositoryConfiguration": {
          "shape": "DataRepositoryConfiguration"
        },
        "DeploymentType": {
          "shape": "LustreDeploymentType",
    ...
    "UpdateFileSystemLustreConfiguration": {
      ...
      "members": {
        "WeeklyMaintenanceStartTime": {
          "shape": "WeeklyTime",
          "documentation": "<p>(Optional) The preferred start time to perform weekly maintenance, formatted d:HH:MM in the UTC time zone. d is the weekday number, from 1 through 7, beginning with Monday and ending with Sunday.</p>"
        },
        "DailyAutomaticBackupStartTime": {
          "shape": "DailyTime"
        },
    ...
    "WindowsFileSystemConfiguration": {
      ...
      "members": {
        ...
        "AutomaticBackupRetentionDays": {
          "shape": "AutomaticBackupRetentionDays",
          "documentation": "<p>The number of days to retain automatic backups. Setting this to 0 disables automatic backups. You can retain automatic backups for a maximum of 90 days.</p>"
        },
        "CopyTagsToBackups": {
          "shape": "Flag",
